    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <!-- <div class="text-center">
            ...
            <h1>SISTEM INFORMASI LAYANAN PERLENGKAPAN TERPADU</h1>
            <h1></h1>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <?php $titleDashboard = '';
                if (session()->get('role') == session()->get('props')->roleKaro) {
                  $titleDashboard = 'Dashboard Karoum';
                } else if (session()->get('role') == session()->get('props')->roleKabag) {
                  $titleDashboard = 'Dashboard Kabag PPBJ';
                } else if (session()->get('role') == session()->get('props')->roleSubPengadaan) {
                  $titleDashboard = 'Dashboard Subbag Pengadaan';
                } else if (session()->get('role') == session()->get('props')->roleSubBMN) {
                  $titleDashboard = 'Dashboard Subbag BMN';
                } else if (session()->get('role') == session()->get('props')->roleSubRumga) {
                  $titleDashboard = 'Dashboard Subbag Rumga';
                } ?>
                <h5 class="card-title"><?= $titleDashboard; ?></h5>
                ...
                <div class="row">
                  <?php if (
                    ...
                    <div class="col-lg-3 col-6">
                      ...
                      <div class="small-box" style="background-color:#DAF7A6">
                        <div class="inner">
                          <h3><?= $totalPengadaanMasuk->total; ?><sup style="font-size: 20px"> Pengadaan</sup></h3>
                  ...
                  <?php if (
                    ...
                    <div class="col-lg-3 col-6">
                      ...
                      <div class="small-box" style="background-color:#FFC300">
                        <div class="inner">
                          <h3><?= $totalPengadaanPerluDikirim->total; ?><sup style="font-size: 20px"> Pengadaan</sup></h3>
                  ...
                  <?php if (
                    ...
                    <div class="col-lg-3 col-6">
                      ...
                      <div class="small-box" style="background-color:#DAF7A6">
                        <div class="inner">
                          <h3><?= $totalPeminjamanRandisMasuk->total; ?><sup style="font-size: 20px"> Peminjaman Randis</sup></h3>

                          <p>Belum Direspon</p>
                        </div>
                        <a href="<?php echo base_url('peminjaman-randis-req'); ?>" class="small-box-footer">Detail <i class="fas fa-arrow-circle-right"></i></a>
                      </div>
                    </div>
                    <!-- ./col -->
                  <?php endif; ?>
                          ...
                          <tbody>
                            ...
                            ?>
                              <tr>
                                ...
                                <td class="<?= $row->status_kirim == '0' ? 'alert-danger' : 'alert-warning' ?>"><?= $row->keterangan_kirim . "<br/>" . $tgl_distribusi . ""; ?></td>
                              </tr>
                            <?php endforeach; ?>
                          </tbody>
                        </table>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h5 class="card-title">Dashboard Pengguna</h5>
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                  <i class="fas fa-minus"></i>
                </button>

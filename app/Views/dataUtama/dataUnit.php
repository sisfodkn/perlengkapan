                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a title="Hapus" href="<?= base_url("delete-unit/$idEncryption"); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin menghapus <?= $row['nama_unit']; ?> ?')"><?= session()->get('props')->tombol_delete; ?></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>

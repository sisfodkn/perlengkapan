                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a title="Hapus" href="<?= base_url("delete-atk/$idEncryption"); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin menghapus <?= $row['nama_atk']; ?> ?')"><?= session()->get('props')->tombol_delete; ?></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
